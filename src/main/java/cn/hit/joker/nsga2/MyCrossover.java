 ...
 * @description
 */
public class MyCrossover extends AbstractCrossover {
    public MyCrossover(CrossoverParticipantCreator crossoverParticipantCreator) {
    ...
    private Chromosome prepareChild(Chromosome parent1, Chromosome parent2, int partition1, int partition2) {
        ...
        for(int i = 0; i < parent1.getLength(); i++)
            childgeneticCode.add(i, (IntegerAllele) parent2.getAllele(i));
